...
<div class="card">
  <h5 class="card-header">Edit Home Page Heding Information Setting</h5>
  @include('backend.layouts.notification')
  <div class="card-body">
    @include('backend.layouts.tablinks')
    <form method="post" action="{{route('settings.homepageheding.update')}}" enctype="multipart/form-data">
      @csrf
