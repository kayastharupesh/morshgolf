...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}"  enctype="multipart/form-data">
        ...
        {{-- <div class="row">
          ...
          <div class="col-xl-3 col-md-6 mb-4">
            <div class=" h-100 py-2">
              <label for="address" class="col-form-label">Country <span class="text-danger">*</span></label>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class=" h-100 py-2">
            <label for="address" class="col-form-label">State <span class="text-danger">*</span></label>
          ...
          <div class="col-xl-3 col-md-6 mb-4">
            <div class=" h-100 py-2">
              <label for="address" class="col-form-label">City <span class="text-danger">*</span></label>
              <input type="text" class="form-control" name="city" required value="{{$data->address}}">
              @error('address')
              <span class="text-danger">{{$message}}</span>
              @enderror
            </div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class=" h-100 py-2">
          <label for="address" class="col-form-label">Postcode <span class="text-danger">*</span></label>
          <input type="text" class="form-control" name="postcode" required value="{{$data->postcode}}">
          @error('postcode')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
      ...
      <div class="row">
        <div class="col-xl-6 col-md-12 mb-12">
          ...
          <textarea class="form-control" name="contactus_map_location" rows="14">{{$data->contactus_map_location}}</textarea>
      ...
      <div class="row">
        <div class="col-xl-6 col-md-6 mb-6">
          ...
          <input type="text" class="form-control" name="newletter_heading" required value="{{$data->newletter_heading}}">
        ...
        <div class="col-xl-6 col-md-6 mb-6">
          ...
          <input type="text" class="form-control" name="newsletter_subheading" required value="{{$data->newsletter_subheading}}">
      ...
      <div class="form-group mt-4">
        ...
        <div class="col-xl-12 col-md-12 mb-2">
          <div class=" h-100 ">
            ...
            <textarea name="meta_description" class="form-control" rows="2" cols="20">{{ $data->meta_description }}</textarea>
