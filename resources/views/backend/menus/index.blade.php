      ...
      <div class="dd nestable" id="nestable">
        <ol class="dd-list">
          @foreach ($menus as $menu)
            <li class="dd-item" data-id="{{ $menu->id }}" data-name="Services" data-slug="services-slug-{{ $menu->id }}" data-new="0" data-deleted="0">
              ...
              {{-- <ol class="dd-list">
                <li class="dd-item" data-id="4" data-name="UI/UX Design" data-slug="uiux-slug-4" data-new="0"
                  data-deleted="0">
