...
<div class="sidebar-brand-text mx-3"><img src="https://morshgolf.com/wp-content/uploads/2020/01/morsh-golf-logo-est.png" style="width:100%;"></div>
    </a>
    <!-- Divider -->
    ...
    {{-- <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsVendor" aria-expanded="true" aria-controls="collapsVendor">
