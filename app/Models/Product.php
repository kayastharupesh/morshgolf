...
{
    protected $fillable=['title','product_sub_title','rating','no_of_product_sold','hand_orientation','shaft_material','flex','configuration','volume','length','swing_weight','slug','summary','discount_update','discount_update_date','description','product_description','technical_details','cat_id','child_cat_id','price','brand_id','discount','status','photo','size','stock','is_featured','is_cross_sell','condition','meta_title','meta_keyword','meta_description','extra_code'];
