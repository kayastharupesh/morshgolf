...
class ShippingController extends Controller
{
    ...
    {
        $contient_list = Continent::orderBy('continent_name','ASC')->get();
        return view('backend.shipping.create')->with('contient_list',$contient_list);
    }
    ...
    public function country_view_contient_wise(Request $request)
    {
        $contient_id = $request->post('contient_id');
        $country_list= Country::where('continent_id',$contient_id)
            ->get();
        return $country_list;    
    }
